...
$(document).ready(function(){
	...
	$(".sidebar-menu > li.have-children .linked").on("click", function(i){
		  i.preventDefault();
...
$(document).ready(function()
    {
        ...
        $(".zoom-area").mousemove(function(e){
            ...
            else
            {
                ...
                if($(".large").is(":visible"))
                {
                    var rx = Math.round(mx/$(".small").width()*sub_width - $(".large").width()/4)*-1;
                    var ry = Math.round(my/$(".small").height()*sub_height - $(".large").height()/4)*-1;

                    var bgp = rx + "px " + ry + "px";
                    
                    var px = mx - $(".large").width()/4;
                    var py = my - $(".large").height()/4;
